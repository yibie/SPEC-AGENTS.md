# Fixed Brief: Meeting-room reservation

This Brief is shared by both runs. Do not change it during the experiment.
...
- Offer three meeting rooms.
- Create a reservation with topic, person, local date, start time, end time,
  and room.
...
|---|---|---|
| R1 | Initial load | Three rooms, form, reservation list, and clear empty state |
| R2 | Valid reservation | Active list shows the complete record |
| R3 | End time earlier than or equal to start | Reject with nearby field error; create nothing |
