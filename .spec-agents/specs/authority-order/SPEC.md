...
status: superseded
revision: 2
context_refs: `AGENTS.md`, `.spec-agents/doctrine/AGENTS_en.md`, `.spec-agents/doctrine/docs/single-authority.md`, `.spec-agents/doctrine/docs/knowledge-promotion.md`, `.spec-agents/doctrine/skills/do/SKILL.md`, `.spec-agents/doctrine/skills/learn/SKILL.md`, `docs/adr/0006`
...
- **r2** — superseded before arrangement by
  `.specs/namespaced-project-layout/SPEC.md`. That breaking layout change
  retains every confirmed decision here but applies it at the new canonical
  Doctrine paths, avoiding an implementation against paths that are about to
  retire.
