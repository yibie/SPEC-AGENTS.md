...
context_ref: `.spec-agents/state/EVIDENCE.md`, `docs/adr/0010-upgrade-rebootstrap.md`, `docs/runbooks/installer-smoke.md`, `CHANGELOG.md`, `.spec-agents/state/STATUS.md`
