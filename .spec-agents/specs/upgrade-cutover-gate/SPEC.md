...
context_refs: `.spec-agents/doctrine/UPGRADE.md`, `.spec-agents/doctrine/START.md`, `.spec-agents/doctrine/bin/spec-agents`,
  `.spec-agents/doctrine/docs/WORKFLOW.md`, `docs/adr/0010-upgrade-rebootstrap.md`,
  `docs/runbooks/installer-smoke.md`,
  `.spec-agents/specs/salvage-reset-start/SPEC.md`, `.spec-agents/state/EVIDENCE.md`
