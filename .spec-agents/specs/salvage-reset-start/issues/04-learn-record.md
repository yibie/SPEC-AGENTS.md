...
blocked_by: 03
writer: learn
authority: `.spec-agents/doctrine/docs/WORKFLOW.md` — Upgrade and ProjectState
spec_ref: `.spec-agents/specs/salvage-reset-start/SPEC.md`
context_ref: `.spec-agents/state/EVIDENCE.md`, `docs/adr/0001-framework-namespace-split.md`, `.spec-agents/state/STATUS.md`, `CHANGELOG.md`
