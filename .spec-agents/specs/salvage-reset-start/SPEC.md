...
context_refs: `AGENTS.md`, `.spec-agents/doctrine/START.md`, `.spec-agents/doctrine/UPGRADE.md`,
  `.spec-agents/doctrine/docs/WORKFLOW.md`, `docs/adr/0001-framework-namespace-split.md`,
  `docs/runbooks/installer-smoke.md`, `.spec-agents/scratch/herdr-field-trial-20260830/RESULTS.md`
