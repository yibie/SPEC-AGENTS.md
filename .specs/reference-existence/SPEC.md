...
status: confirmed
revision: 1
context_refs: `AGENTS.md`, `skills/`, `templates/CONTEXT.md`, `.phrase/README.md`, `bin/spec-agents`, `docs/runbooks/installer-smoke.md`, `tests/doctrine-check.sh`, `docs/adr/0001`, `docs/adr/0007`
