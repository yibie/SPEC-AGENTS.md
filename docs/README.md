...
`.spec-agents/doctrine/docs/` is the exception: it holds SPEC-AGENTS doctrine, is written
...
Raw observations remain in `.spec-agents/state/EVIDENCE.md` until `learn` classifies and promotes
